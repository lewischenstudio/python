...
circular_CDLL.insert_CDLL(2,0)
circular_CDLL.insert_CDLL(1,0)
circular_CDLL.insert_CDLL(3,1)
circular_CDLL.insert_CDLL(4,1)
circular_CDLL.insert_CDLL(5,3)
circular_CDLL.insert_CDLL(6,6)
circular_CDLL.insert_CDLL(7,9)
print([node.value for node in circular_CDLL])